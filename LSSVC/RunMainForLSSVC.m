...
% load CPX.mat X Y
% load CPX_pos.mat X Y
% load CPXX.mat X Y
% load CPXX_pos.mat X Y
% load CPXX_pos_x.mat X Y
% load CPXX_neg.mat X Y


% load CPXX_015Label.mat X Y
% load CPXX_015Label_1.mat X Y

% load CP.mat X Y
% load 1.mat X Y
load windmill10.mat X Y
...
%■■■非十折交叉验证， 即有训练集也有预测集■■■
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% FunPara = LSSVCParaSearch(Data,SVMFun,FunPara);
% % % % FunPara = LSSVCNoKfoldParaSearch(Data,SVMFun,FunPara);
